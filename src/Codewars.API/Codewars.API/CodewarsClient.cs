...
namespace Codewars.API
{
    ...
    public class CodewarsClient
    {
        ...
        /// <returns>information about a specific user</returns>
        ...
        /// <returns>information about a specific code challenge (kata)</returns>
        ...
        /// <returns>AttemptSolutionResponse</returns>
        ...
        /// <param name="projectId">This ID value will be needed when submitting a solution.</param>
        /// <param name="solutionId">This ID value will be needed when submitting a solution.</param>
        /// <returns>a success message if there has been a previously successful solution.</returns>
        ...
        /// <returns>DeferredResponse</returns>
